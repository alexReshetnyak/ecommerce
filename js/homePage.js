function HomePage (routerOutlet, newHandlebars) {
...
HomePage.prototype._renderProduct = function(){
	var self = this;
	var dataSlider1 = this._createDataTemplateSlider(this._dataFromServer, 'views');
	var dataSlider2 = this._createDataTemplateSlider(this._dataFromServer, 'auto');
...
HomePage.prototype._createDataTemplateSlider = function(dataArray,  sort){
	var countSlids;
...
HomePageSlider.prototype._activeSlider = function(){
 ...
 window.app.HomePage = window.app.HomePage || HomePage;